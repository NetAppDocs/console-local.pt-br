...
Use o Workload Analyzer para uma análise detalhada e baseada no tempo do volume afetado. Para perguntas em linguagem natural ou para análise de alto nível em todos os recursos permitidos, use o assistente do Console. link:reference-console-assistant-operations.html["Saiba mais sobre as operações compatíveis do assistente do Console."]
