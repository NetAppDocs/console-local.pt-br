...
Todas as funções, exceto administrador da Federação e visualizador da Federação. Usuários com a função de administrador da Federação ou visualizador da Federação não podem visualizar alertas. link:reference-iam-predefined-roles.html["Saiba mais sobre funções de acesso"].
