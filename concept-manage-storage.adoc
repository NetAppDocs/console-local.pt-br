...
* link:concept-storage-classes.html["Saiba mais sobre classes e políticas de armazenamento na implantação local do NetApp Console"].
* link:task-iam-manage-folders-fleets.html["Aprenda como criar e gerenciar frotas"].
