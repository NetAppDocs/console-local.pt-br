...
NetApp oferece duas maneiras de executar sua plataforma de gerenciamento de storage unificado: NetApp Console e NetApp Console implantação local. Ambas compartilham uma base comum, mas diferem em arquitetura, conectividade, escopo de recursos e modelo operacional. NetApp Console utiliza agentes do Console implantados em seu ambiente para gerenciar sistemas de storage. NetApp Console implantação local é uma máquina virtual sem agente. NetApp Console implantação local se comunica diretamente com clusters ONTAP e oferece recursos de gerenciamento de frota corporativa que não estão disponíveis no NetApp Console.
...
link:https://docs.netapp.com/us-en/concept-netapp-console-local.html["Saiba mais sobre a implantação local do NetApp Console^."]
