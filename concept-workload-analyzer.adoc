...
Para perguntas em linguagem natural e análises de alto nível em recursos permitidos, use o assistente do NetApp Console. link:reference-console-assistant-operations.html["Saiba mais sobre as operações compatíveis do assistente do Console."]
