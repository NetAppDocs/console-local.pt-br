...
Para obter detalhes sobre como organizar frotas, consulte link:concept-manage-storage.html["Saiba mais sobre gerenciamento de frotas na implantação local do NetApp Console"].
...
* Para entender a organização da frota, consulte link:concept-manage-storage.html["Saiba mais sobre gerenciamento de frotas na implantação local do NetApp Console"].
* Para criar políticas e classes de armazenamento, consulte link:task-storage-class-manage.html["Gerenciar classes de storage e políticas"].
...
* Para analisar e remediar a deriva, consulte link:task-storage-class-drift-remediate.html["Corrigir a deriva da storage class"]
