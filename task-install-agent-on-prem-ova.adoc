...
summary: Se você for usuário do VMware, pode usar um arquivo OVA para instalar um agente do Console no seu vCenter. O download ou a URL do OVA estão disponíveis por meio da NetApp Console implantação local. 
---
