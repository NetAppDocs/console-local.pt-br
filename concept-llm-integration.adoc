...
summary: Saiba como a implantação local do NetApp Console se integra aos modelos OpenAI e compatíveis com OpenAI, incluindo decisões sobre provedor, proxy e segurança. 
---
