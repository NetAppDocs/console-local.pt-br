...
Controle os custos do assistente do Console escolhendo um provedor e modelo de LLM adequados, definindo limites de uso e alertas com seu provedor e monitorando o uso de tokens. Somente as atividades que enviam solicitações ao LLM consomem tokens do provedor; as operações de backend não consomem.
