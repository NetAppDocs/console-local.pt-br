...
* *Os alertas do ONTAP* têm origem no ONTAP Event Management System (EMS) nos clusters locais que a implantação local do Console descobriu. link:https://docs.netapp.com/us-en/ontap-ems/acp-auto-events.html["Saiba mais sobre o ONTAP EMS e os alertas disponíveis."^]
...
* link:task-alert-rules-manage.html["Crie e gerencie regras de notificação de alerta"]
