...
summary: Antes de abrir um chamado de suporte com o suporte técnico da NetApp, você precisa adicionar uma conta do site de suporte da NetApp à implantação local do NetApp Console e, em seguida, registrar-se para suporte. 
---
